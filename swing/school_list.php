...
<article class="container_12">
    <section class="grid_12">
        <div class="block-border">
            <form action="<?php ActionLink('ajaxlist','school')?>" method="post" id="mainForm" class="block-content form">
				<input type="hidden" id="pageIndex" name="pageIndex" value="1" />
				<input type="hidden" id="pageSize" name="pageSize" value="20" />
				<input type="hidden" id="orderBy" name="orderBy" value="" />
                <h1>学校管理</h1>	
		        <div class="block-controls">
				    <div class="AddLink"><a class="editor" href="<?php ActionLink('dialogeditor','school',array('id' => 0))?>" title="新增学校"><span></span><q>新增学校</q></a></div>
			        <ul class="controls-buttons">
				        <li><input id="name" name="name" type="text" placeholder="输入学校名称查询" /></li>
                    ...
                    <thead>
                        <tr class="mainTable-head">
                            <th scope="col">
                                ...
                                <a href="javascript:;" title="单击排序" class="btn-sort-order" sort-expression="Name">学校名称</a>
                            </th>
                            <th scope="col">
                                <span class="column-sort">
						            <a class="sort-up"></a>
