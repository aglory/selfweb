...
<header class="wrap">
	<ul class="navigation">
		...
		<li class="navigationitem"><a <?php if(Model=='apply'){ ?>class="current"<?php }?> href="<?php ActionLink('apply','apply')?>">在线报名</a></li>
		<li class="navigationitem"><a <?php if(Model=='message'){ ?>class="current"<?php }?> href="<?php ActionLink('index','message')?>">咨询留言</a></li>
		<li class="navigationitem"><a <?php if(Model=='job'){ ?>class="current"<?php }?> href="<?php ActionLink('index','job')?>">就业安置</a></li>
